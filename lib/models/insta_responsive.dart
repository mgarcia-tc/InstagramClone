...
class DataUser {
    ...
    factory DataUser.fromJson(Map<String, dynamic> json) => DataUser(
        ...
        bioLinks: json["bio_links"] == null ? [] : List<BioLink>.from(json["bio_links"]!.map((x) => BioLink.fromJson(x))),
        ...
        edgeFollowedBy: json["edge_followed_by"] == null ? null : EdgeFollowClass.fromJson(json["edge_followed_by"]),
        fbid: json["fbid"],
        followedByViewer: json["followed_by_viewer"],
        edgeFollow: json["edge_follow"] == null ? null : EdgeFollowClass.fromJson(json["edge_follow"]),
        ...
        pronouns: json["pronouns"] == null ? [] : List<dynamic>.from(json["pronouns"]!.map((x) => x)),
        edgeFelixVideoTimeline: json["edge_felix_video_timeline"] == null ? null : EdgeFelixVideoTimelineClass.fromJson(json["edge_felix_video_timeline"]),
        edgeOwnerToTimelineMedia: json["edge_owner_to_timeline_media"] == null ? null : EdgeFelixVideoTimelineClass.fromJson(json["edge_owner_to_timeline_media"]),
        edgeSavedMedia: json["edge_saved_media"] == null ? null : EdgeFelixVideoTimelineClass.fromJson(json["edge_saved_media"]),
        edgeMediaCollections: json["edge_media_collections"] == null ? null : EdgeFelixVideoTimelineClass.fromJson(json["edge_media_collections"]),
        edgeRelatedProfiles: json["edge_related_profiles"] == null ? null : EdgeRelatedProfiles.fromJson(json["edge_related_profiles"]),
    );

    Map<String, dynamic> toJson() => {
        "biography": biography,
        "bio_links": bioLinks == null ? [] : List<dynamic>.from(bioLinks!.map((x) => x.toJson())),
        ...
        "pronouns": pronouns == null ? [] : List<dynamic>.from(pronouns!.map((x) => x)),
...
class EdgeFelixVideoTimelineClass {
    ...
    factory EdgeFelixVideoTimelineClass.fromJson(Map<String, dynamic> json) => EdgeFelixVideoTimelineClass(
        ...
        edges: json["edges"] == null ? [] : List<EdgeFelixVideoTimelineEdge>.from(json["edges"]!.map((x) => EdgeFelixVideoTimelineEdge.fromJson(x))),
    );
...
class PurpleNode {
    ...
    factory PurpleNode.fromJson(Map<String, dynamic> json) => PurpleNode(
        ...
        edgeMediaToComment: json["edge_media_to_comment"] == null ? null : EdgeFollowClass.fromJson(json["edge_media_to_comment"]),
        commentsDisabled: json["comments_disabled"],
        takenAtTimestamp: json["taken_at_timestamp"],
        edgeLikedBy: json["edge_liked_by"] == null ? null : EdgeFollowClass.fromJson(json["edge_liked_by"]),
        edgeMediaPreviewLike: json["edge_media_preview_like"] == null ? null : EdgeFollowClass.fromJson(json["edge_media_preview_like"]),
        location: json["location"] == null ? null : Location.fromJson(json["location"]),
        nftAssetInfo: json["nft_asset_info"],
        thumbnailSrc: json["thumbnail_src"],
        thumbnailResources: json["thumbnail_resources"] == null ? [] : List<ThumbnailResource>.from(json["thumbnail_resources"]!.map((x) => ThumbnailResource.fromJson(x))),
        felixProfileGridCrop: json["felix_profile_grid_crop"],
        coauthorProducers: json["coauthor_producers"] == null ? [] : List<dynamic>.from(json["coauthor_producers"]!.map((x) => x)),
        pinnedForUsers: json["pinned_for_users"] == null ? [] : List<dynamic>.from(json["pinned_for_users"]!.map((x) => x)),
        ...
        clipsMusicAttributionInfo: json["clips_music_attribution_info"] == null ? null : ClipsMusicAttributionInfo.fromJson(json["clips_music_attribution_info"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "thumbnail_resources": thumbnailResources == null ? [] : List<dynamic>.from(thumbnailResources!.map((x) => x.toJson())),
        "felix_profile_grid_crop": felixProfileGridCrop,
        "coauthor_producers": coauthorProducers == null ? [] : List<dynamic>.from(coauthorProducers!.map((x) => x)),
        "pinned_for_users": pinnedForUsers == null ? [] : List<dynamic>.from(pinnedForUsers!.map((x) => x)),
...
class EdgeMediaToCaption {
    ...
    factory EdgeMediaToCaption.fromJson(Map<String, dynamic> json) => EdgeMediaToCaption(
        edges: json["edges"] == null ? [] : List<EdgeMediaToCaptionEdge>.from(json["edges"]!.map((x) => EdgeMediaToCaptionEdge.fromJson(x))),
    );
...
class EdgeMediaToTaggedUser {
    ...
    factory EdgeMediaToTaggedUser.fromJson(Map<String, dynamic> json) => EdgeMediaToTaggedUser(
        edges: json["edges"] == null ? [] : List<EdgeMediaToTaggedUserEdge>.from(json["edges"]!.map((x) => EdgeMediaToTaggedUserEdge.fromJson(x))),
    );
...
class EdgeSidecarToChildren {
    ...
    factory EdgeSidecarToChildren.fromJson(Map<String, dynamic> json) => EdgeSidecarToChildren(
        edges: json["edges"] == null ? [] : List<EdgeSidecarToChildrenEdge>.from(json["edges"]!.map((x) => EdgeSidecarToChildrenEdge.fromJson(x))),
    );
...
final usernameValues = EnumValues({
    "tammy.parra": Username.TAMMY_PARRA
});
...
class EdgeMutualFollowedBy {
    ...
    factory EdgeMutualFollowedBy.fromJson(Map<String, dynamic> json) => EdgeMutualFollowedBy(
        count: json["count"],
        edges: json["edges"] == null ? [] : List<dynamic>.from(json["edges"]!.map((x) => x)),
    );
...
class EdgeRelatedProfiles {
    ...
    factory EdgeRelatedProfiles.fromJson(Map<String, dynamic> json) => EdgeRelatedProfiles(
        edges: json["edges"] == null ? [] : List<EdgeRelatedProfilesEdge>.from(json["edges"]!.map((x) => EdgeRelatedProfilesEdge.fromJson(x))),
    );
